...
#define MC_QOS_CTRL1			K1_DDRC_ADDR(X1_CIU_BASE, 0x118)
#define MC_QOS_CTRL2			K1_DDRC_ADDR(X1_CIU_BASE, 0x11c)
#define MC_QOS_CTRL3			K1_DDRC_ADDR(X1_CIU_BASE, 0x120)
#define MC_QOS_CTRL4			K1_DDRC_ADDR(X1_CIU_BASE, 0x124)
#define CCI_QOS_CTRL			K1_DDRC_ADDR(X1_PLAT_CIU_BASE, 0x98)
#define ISP_QOS_CTRL			K1_DDRC_ADDR(X1_CIU_BASE, 0x1e0)
#define GPU_QOS_CTRL			K1_DDRC_ADDR(X1_CIU_BASE, 0x100)
#define GNSS_QOS_CTRL			K1_DDRC_ADDR(X1_CIU_BASE, 0x1c)
