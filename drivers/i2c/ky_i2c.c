 ...
 *
 */
static void i2c_reset(struct ky_i2c *base)
{
	u32 icr_mode;
 ...
 */
static int i2c_isr_set_cleared(struct ky_i2c *base, unsigned long set_mask,
 ...
 */
static int i2c_transfer(struct ky_i2c *base, struct ky_i2c_msg *msg)
{
	int ret;
...
static int __i2c_read(struct ky_i2c *base, uchar chip, u8 *addr, int alen,
		      uchar *buffer, int len)
{
	struct ky_i2c_msg msg;
...
static int __i2c_write(struct ky_i2c *base, uchar chip, u8 *addr, int alen,
		       uchar *buffer, int len)
{
	struct ky_i2c_msg msg;
...
#define KY_APBC_BASE		0xd4015000	/* APB Clock Unit */
#define REG_APBC_APBC_TWSI0_CLK_RST	(KY_APBC_BASE + 0x2c)
#define REG_APBC_APBC_TWSI1_CLK_RST	(KY_APBC_BASE + 0x30)
#define REG_APBC_APBC_TWSI2_CLK_RST	(KY_APBC_BASE + 0x38)
#define REG_APBC_APBC_TWSI3_CLK_RST	(0xf0610000    + 0x08)
#define REG_APBC_APBC_TWSI4_CLK_RST	(KY_APBC_BASE + 0x40)
#define REG_APBC_APBC_TWSI5_CLK_RST	(KY_APBC_BASE + 0x4c)
#define REG_APBC_APBC_TWSI6_CLK_RST	(KY_APBC_BASE + 0x60)
#define REG_APBC_APBC_TWSI7_CLK_RST	(KY_APBC_BASE + 0x68)
#define REG_APBC_APBC_TWSI8_CLK_RST	(KY_APBC_BASE + 0x20)
...
static struct ky_i2c *i2c_base[] = {
	(struct ky_i2c *)0xd4010800,
	(struct ky_i2c *)0xd4011000,
	(struct ky_i2c *)0xd4012000,
	(struct ky_i2c *)0xf0614000,
	(struct ky_i2c *)0xd4012800,
	(struct ky_i2c *)0xd4013800,
	(struct ky_i2c *)0xd4018800,
	(struct ky_i2c *)0xd401d000,
	(struct ky_i2c *)0xd401d800,
};
...
static void __i2c_init_chip(struct ky_i2c *base, int speed, int slaveaddr)
{
	u32 val;
...
static int __i2c_probe_chip(struct ky_i2c *base, uchar chip)
{
	struct ky_i2c_msg msg;
...
static void ky_i2c_init(struct i2c_adapter *adap, int speed, int slaveadd)
{
	__i2c_init_chip(i2c_base[adap->hwadapnr], speed, slaveadd);
}

/*
 * ky_i2c_probe: - Test if a chip answers for a given i2c address
 */
static int ky_i2c_probe(struct i2c_adapter *adap, uchar chip)
{
 ...
 */
static int ky_i2c_read(struct i2c_adapter *adap, uchar chip, uint addr, int alen, uchar *buffer, int len)
{
	u8 addr_bytes[4];
 ...
 * @return:	0 in case of success
 */
static int ky_i2c_write(struct i2c_adapter *adap, uchar chip, uint addr, int alen, uchar *buffer, int len)
{
	u8 addr_bytes[4];
...
U_BOOT_I2C_ADAP_COMPLETE(ky_i2c0, ky_i2c_init, ky_i2c_probe,
		ky_i2c_read, ky_i2c_write,
		NULL, 100000, 0x31,
		0);
U_BOOT_I2C_ADAP_COMPLETE(ky_i2c1, ky_i2c_init, ky_i2c_probe,
		ky_i2c_read, ky_i2c_write,
		NULL, 100000, 0x31,
		1);
U_BOOT_I2C_ADAP_COMPLETE(ky_i2c2, ky_i2c_init, ky_i2c_probe,
		ky_i2c_read, ky_i2c_write,
		NULL, 100000, 0x31,
		2);
U_BOOT_I2C_ADAP_COMPLETE(ky_i2c3, ky_i2c_init, ky_i2c_probe,
		ky_i2c_read, ky_i2c_write,
		NULL, 100000, 0x31,
		3);
U_BOOT_I2C_ADAP_COMPLETE(ky_i2c4, ky_i2c_init, ky_i2c_probe,
		ky_i2c_read, ky_i2c_write,
		NULL, 100000, 0x31,
		4);
U_BOOT_I2C_ADAP_COMPLETE(ky_i2c5, ky_i2c_init, ky_i2c_probe,
		ky_i2c_read, ky_i2c_write,
		NULL, 100000, 0x31,
		5);
U_BOOT_I2C_ADAP_COMPLETE(ky_i2c6, ky_i2c_init, ky_i2c_probe,
		ky_i2c_read, ky_i2c_write,
		NULL, 100000, 0x50,
		6);
U_BOOT_I2C_ADAP_COMPLETE(ky_i2c7, ky_i2c_init, ky_i2c_probe,
		ky_i2c_read, ky_i2c_write,
		NULL, 100000, 0x31,
		7);
U_BOOT_I2C_ADAP_COMPLETE(ky_i2c8, ky_i2c_init, ky_i2c_probe,
		ky_i2c_read, ky_i2c_write,
		NULL, 100000, 0x31,
		8);
#else /* SYS_I2C_LEGACY */
...
static int ky_i2c_xfer(struct udevice *bus, struct i2c_msg *msg, int nmsgs)
{
	struct ky_i2c_priv *i2c = dev_get_priv(bus);
...
static int ky_i2c_set_bus_speed(struct udevice *bus, unsigned int speed)
{
	struct ky_i2c_priv *priv = dev_get_priv(bus);
	u32 val;
...
static int ky_i2c_bind(struct udevice *bus)
{
	return 0;
}

static int ky_i2c_probe(struct udevice *bus)
{
	struct ky_i2c_priv *priv = dev_get_priv(bus);
	int ret;
	...
	ret = ky_i2c_set_bus_speed(bus, priv->clk_rate);
	return 0;
}

static const struct dm_i2c_ops ky_i2c_ops = {
	.xfer		= ky_i2c_xfer,
	.set_bus_speed	= ky_i2c_set_bus_speed,
};

static const struct udevice_id ky_i2c_ids[] = {
	{ .compatible = "ky,i2c" },
	{ }
};

U_BOOT_DRIVER(i2c_ky) = {
	.name	= "i2c_ky",
	.id	= UCLASS_I2C,
	.of_match = ky_i2c_ids,
	.bind	= ky_i2c_bind,
	.probe	= ky_i2c_probe,
	.priv_auto = sizeof(struct ky_i2c_priv),
	.ops	= &ky_i2c_ops,
};
#endif /* CONFIG_DM_I2C */
