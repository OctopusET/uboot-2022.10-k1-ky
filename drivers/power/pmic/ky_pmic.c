...
static const struct udevice_id pm8xx_ids[] = {
	{ .compatible = "ky,spm8821", .data = (ulong)&spm8821_regulator_match_data, },
	{ .compatible = "ky,pm853", .data = (ulong)&pm853_regulator_match_data, },
	{ .compatible = "ky,sy8810l", .data = (ulong)&sy8810l_regulator_match_data, },
	{ }
};
