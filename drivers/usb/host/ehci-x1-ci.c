...
/*
 * EHCI Driver Wrapper for Ky x1 SoCs
 *
...
static int ehci_mv_probe(struct udevice *dev)
{
	...
	apmu_node = ofnode_by_compatible(ofnode_null(), "ky,x1-pm-domain");
	...
	dev_info(dev, "ehci-x1-ci: init hccr %lx and hcor %lx hc_length %ld\n",
