...
void ky_dphy_get_status(struct ky_dphy_ctx *dphy_ctx)
{
	if(NULL == dphy_ctx){
		pr_info("%s: Invalid param\n", __func__);
		return;
...
void ky_dphy_reset(struct ky_dphy_ctx *dphy_ctx)
{
	if(NULL == dphy_ctx){
		pr_info("%s: Invalid param\n", __func__);
		return;
 ...
 *
 */
void ky_dphy_init(struct ky_dphy_ctx *dphy_ctx)
{
	if(NULL == dphy_ctx){
		pr_info("%s: Invalid param\n", __func__);
		return;
 ...
 *
 */
void ky_dphy_uninit(struct ky_dphy_ctx *dphy_ctx)
{
	if(NULL == dphy_ctx){
		pr_info("%s: Invalid param\n", __func__);
		return;
