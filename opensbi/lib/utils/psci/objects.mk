...
libsbiutils-objs-$(CONFIG_ARM_PSCI_SUPPORT) += psci/ky/ky_topology.o

ifeq ($(CONFIG_ARM_NON_SCMI_SUPPORT), y)
# common
libsbiutils-objs-$(CONFIG_ARM_NON_SCMI_SUPPORT) += psci/ky/plat/plat_pm.o

# platform
libsbiutils-objs-$(CONFIG_PLATFORM_KY_X1) += psci/ky/plat/x1/underly_implement.o
endif
